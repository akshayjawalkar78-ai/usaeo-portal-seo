...
export default function ChapterRegister() {
  const [form, setForm] = useState({ name: '', email: '', school: '', grade: '', state: '', notes: '' });
      ...
      <PageLayout>
        <section className="min-h-[70vh] flex items-center justify-center px-5">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-lg">
            ...
            <p className="text-muted-foreground mb-6">We've received your Chapter Founder application. Our team will review it and be in touch within a few business days.</p>
            <Link to="/chapters" className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:underline">
      ...
      <section className="pt-20 pb-24 px-5">
        <div className="max-w-lg mx-auto">
          ...
          <motion.form initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            <div>
              <label className="block text-xs font-semibold text-foreground mb-1.5">Why do you want to start a chapter? (optional)</label>
              <textarea value={form.notes} onChange={set('notes')} rows={3} placeholder="Tell us about your school and your interest in economics..."
            ...
            <p className="text-xs text-muted-foreground text-center">
              Our team reviews all applications and responds within a few business days.
            </p>
          </motion.form>
        </div>
      </section>
